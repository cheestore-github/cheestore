...
class ProfileMrketer(models.Model):
    ...
    gender = models.CharField(verbose_name='جنسیت', choices = gender_choices, max_length=8, blank=True, null=True)
    id_number = models.CharField(verbose_name='شماره شناسنامه', max_length=10, unique=True)
    ...
    zip_code= models.CharField(verbose_name='کدپستی', max_length=10, null=True, blank=False, default='')
